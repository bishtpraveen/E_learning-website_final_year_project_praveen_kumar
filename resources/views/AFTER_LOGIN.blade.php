...
<div id="courserat1" style="border: 1px solid grey;border-radius: 15px;height: 60vh;width: 45vh;box-shadow: 0px 0px 10px grey;">
        
    <img style="height: auto; width: 100%;border-radius: 15px 15px 0px 0px;"
      src="http://www.bwsgirls.org/wp-content/uploads/2020/06/97349149-finance-and-business-concept-investment-graph-and-rows-growth-and-of-coins-on-table-blue-color-tone--410x273.jpg"
      alt="">

    <div class="p-3">
      <p class="text-muted">Eonomy</p>
      <h3>Macro Economy</h3>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="row p-5" style="display: flex; justify-content: space-around;">
                ...
                <div class="col-md-3" style=" border-radius: 15px; box-shadow: 0px 0px 5px grey;">
                    <div class=" row  p-3"
                        style="border-radius: 15px 15px 0px 0px; background: linear-gradient( white 0.0001%,grey 99%)">
                        <p>BUSINESS PACKAGE
                        </p>
    ...
    <div class="row ">
      ...
      <div class="row">
        ...
        <div class="col-md-3 ">
          ...
          <img id="sep24img1" style="height: 70%; width: 100%; border-radius: 15px;"
            src="https://anneknock.files.wordpress.com/2011/09/learn-your-way.jpg?w=300&h=199" alt="">
        ...
        <div class="col-md-3 ">
          ...
          <img id="sep24img2" style="height: 70%; width: 100%;border-radius: 15px;"
            src="https://www.chotot.com/kinhnghiem/wp-content/uploads/2018/12/viec-lam-online-1.jpg" alt="">
          <p class="my-1 text-muted">24 september 2017</p>
