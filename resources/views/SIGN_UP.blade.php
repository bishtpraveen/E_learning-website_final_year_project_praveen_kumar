...
<!-- signup form -->
 ...
 @if(Session::has('validatorError'))
      ...
      @endif
            <form action="{{url('user_signup_form')}}" enctype="multipart/form-data"   method="post"  style="  border-radius: 15px; border: 1px solid white; box-shadow: 0px 0px 50px grey; "  class="p-5 ">
            @csrf
            
                <h3 style="border-bottom: 1px solid white; color: white;" class="text-center p-2">SignUp User</h3>
                <div class="my-5" style="display: flex; box-sizing: border-box;">
                    <i style="color: white;"  class="fas fa-user mr-1 mt-2"></i>
                    
                    <input style=" background: transparent; border-radius: 15px 45px; " name="username"  type="text" placeholder=" Enter Your Name" class="form-control bg-light" >
                  </div>
                <div class="my-5" style="display: flex; box-sizing: border-box;">
                  ...
                  <div class="my-5" style="display:flex">
                    ...
                    <input style=" background: transparent; border-radius: 15px 45px; " name="password" type="password" placeholder="Choose A Password" class="form-control bg-light">
                  ...
                  <div class="my-5" style="display:flex">
                    ...
                    <input style=" background: transparent; border-radius: 15px 45px; " name="pro_img" type="file" placeholder="Upload Profile Image" class="form-control bg-light"  >
            
                  </div>
                  
                  <input type="checkbox"  name="checkbox" value="true" ><span class="ml-2"  style="color: white;" > I agreed to the terms and
                    conditions.</span>
                    <p class=" my-5 ">   <input type="submit" value="Sign Up"  class="btn btn-primary btn-outline-light   form-control  "></p>
        ...
        <h3 class="text-center my-5 p-5" > <a class="text-light " style="text-decoration: none;"  href="{{url('become_a_teacher')}}"> Become A Teacher</a></h3>
      
<a href="{{url('educator_signup')}}" class="btn btn-primary btn-outline-light  form-control  " >SignUp as an educator</a>
<h5 class="text-center  my-5">Already An Educator?</h5>
<h3 class="text-center ">Login here</h3>
<a href="{{url('educator_login')}}" class="btn btn-primary btn-outline-light  form-control " > Educator Login here </a>
<h5  class="text-primary my-4 ">
<a class="text-primary my-4 bg-light p-2 " style="text-decoration: none;border-radius:15px " href="{{url('become_a_teacher')}}">Learn More</a>
