...
<!-- signup form -->
 ...
 @if(Session::has('validatorError'))
      ...
      @endif
            <form action="{{url('educator_signup_form')}}" enctype="multipart/form-data"   method="post"  style="  border-radius: 15px; border: 1px solid white; box-shadow: 0px 0px 50px grey; "  class="p-5 ">
            @csrf
            
                <h3 style="border-bottom: 1px solid white; color: white;" class="text-center p-2">SignUp Educator</h3>
