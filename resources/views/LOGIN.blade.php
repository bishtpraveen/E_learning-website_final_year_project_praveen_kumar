  ...
  success:function(data){
   ...
   $('#msg').html('link is sent to your register email')
    ...
    return false;
            ...
            <form action="{{url('user_login_form')}}" method="post"  style="  border-radius: 15px; border: 1px solid white; box-shadow: 0px 0px 50px grey; "  class="p-5 ">
            @csrf
            
                <h3 style="border-bottom: 1px solid white; color: white;" class="text-center p-2">Login User </h3>
