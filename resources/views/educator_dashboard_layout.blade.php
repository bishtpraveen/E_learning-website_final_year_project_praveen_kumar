            ...
            <div class="col-md-8 ">
                ...
                <nav class="navbar navbar-expand-md px-0  ">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                  <a href="{{url('logout')}}" class="nav-link text-light"><i class="fas fa-sign-out-alt"></i></a>
              </li>
              <li class="nav-item dropdown">
                      ...
                      @elseif(!Session::has('email'))
                        <li class="nav-item">
                  <a href="{{url('login')}}" class="nav-link"><button
                          class="btn btn-light btn-outline-primary">Login</button></a>
              </li>
              <li class="nav-item">
                  <a href="{{url('sign_up')}}" class="nav-link"><button
                          class="btn btn-light btn-outline-primary">SignUp</button></a>
              </li>
@else
              <li class="nav-item">
              ...
              <li class="nav-item dropdown">
     <a href="" class="btn btn-light btn-outline-primary  nav-link "><i class="far fa-user"> {{Session::get('username')}}</i></a>
        ...
        <div class="row "  style="background-color: #1E90FF;" >
            ...
            <div class="col-md-8 ">
               ...
               <li class="nav-item dropdown">
                ...
                <li class="nav-item">
                    <a href="" style="color: white;" class="nav-link"><i class="fas fa-search"></i></a>
                </li>
